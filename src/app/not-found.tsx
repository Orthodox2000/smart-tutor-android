    ...
    <div className="flex items-center justify-center bg-slate-200 min-h-screen">
      <div className="w-full max-w-[430px] bg-white min-h-screen sm:min-h-0 sm:h-[85vh] sm:max-h-[780px] relative overflow-hidden shadow-2xl flex flex-col items-center justify-center sm:rounded-3xl p-8">
        ...
        <div className="relative z-10 w-full flex flex-col items-center text-center">
          ...
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2">Error 404</p>
          <h1 className="text-lg font-black text-slate-900 tracking-tight mb-2">Page Not Found</h1>
          ...
          <div className="w-full space-y-3">
            ...
            <button
              onClick={() => router.back()}
              className="w-full flex items-center justify-center gap-2 bg-slate-100 py-4 rounded-2xl font-bold text-[15px] text-slate-600 transition-all active:scale-[0.98]"
            >
              <ArrowLeft size={18} />
              Go Back
            </button>
